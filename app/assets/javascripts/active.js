document.addEventListener("turbolinks:load", function() {
  ...
  (function($) {
    ...
    $('.testext_active').slick({
      ...
      arrows: true,
      draggable: false,
      prevArrow: '<button type="button" class="wen-slick-prev"><i class="fas fa-arrow-left"></i></button>',
      nextArrow: '<button type="button" class="wen-slick-next"><i class="fas fa-arrow-right"></i></button>',
      fade: true,
      dots: false,
